...
export const UserHeaderComponent = ({categories, darkThemeToggle, user, logout}) => {
  return (
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                        ...
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <li>
                                    ...
                                    md:dark:text-blue-500" aria-current="page">{user.email}</Link>
                                </li>
...
export const NonUserHeaderComponent = ({categories, darkThemeToggle}) => {
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 fixed w-full z-20 top-0 start-0 ">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2">
                    ...
                    <Link to='/checkout'>
                        <Badge  badgeContent={4} color="primary" className='cursor-pointer'>
                            <ShoppingCartOutlined className='dark:color-white'/>
                        </Badge>
                    </Link>
